...
describe("TennisScorer", () => {
  ...
  it("Jugador 2 marca 4 puntos y jugador 1 marca 3 puntos", () => {
    const scorer = new TennisScorer();
    scorer.player2Scores();
    scorer.player2Scores();
    scorer.player2Scores();
  ...
  it("Jugador 1 marca 5 puntos y jugador 2 marca 3 puntos", () => {
    const scorer = new TennisScorer();
    scorer.player1Scores();
    scorer.player1Scores();
    scorer.player1Scores();
  ...
  it("Jugador 2 marca 5 puntos y jugador 1 marca 3 puntos", () => {
    const scorer = new TennisScorer();
    scorer.player2Scores();
    scorer.player2Scores();
    scorer.player2Scores();
